...
for (i in 1:n) { #n = the number of samples
  ...
  dirNN <- (paste0(dir0, sceL[1],"/", status)) #the directory to find the matrix
...
for (i in 1:n) {
  ...
  dirI <- paste0(dir0, sceL[length(sceL)], "/", sceL[1],"/")
  ...
  pdf(paste0(dirI, sceL[1]," Empty Drops Knee Plot.pdf"))
  ...
  pdf(paste0(dirI, sceL[1]," Diagnostic Plots.pdf"))
  ...
  counts <- counts(sce)
  write10xCounts(counts, path = paste0(dir0, sceL[length(sceL)], "/", sceL[1],"/EmptyDrops/"))
}
```