...
metadata <- list(
  names = c("sampleID", "time", "condition", "data", "strain", "strain2", "sex", "stage", "SLX", "experiment", "bc_swapping"),
  ...
  sce3 = c("SIGAD10", "10", "HC", "23-May-19", "Cx3", "Cx3", "F", "HC", "SLX-17850", "Cx3-HC", "SCI", "without Barcode Swapping"),
  ...
  sce10 = c("SIGAG9.D3", "3", "SCI", "20-Jul-19", "Cx3", "Cx3", "M", "3", "SLX-17998", "Cx3-3", "SCI", "without Barcode Swapping"),
  sce11 = c("SIGAG11.D2", "2", "HC", "20-Jul-19", "Cx3", "Cx3", "F", "HC", "SLX-17998", "Cx3-HC", "SCI", "without Barcode Swapping"),
